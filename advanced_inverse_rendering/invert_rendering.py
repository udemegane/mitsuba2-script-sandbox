...
def main():
    ...
    parser.add_argument('--scene', default='../data/scene/invert_heightfield.xml')
    parser.add_argument('--ref_image', default='../data/refimages/mitsuba_logo.exr')
    parser.add_argument('--out', default='../data/output/invert_heightfield/')
    parser.add_argument('--spp', default='4')
    parser.add_argument('--lr', default='0.01')
    parser.add_argument('--iter', default='100')
    parser.add_argument('--pre_render_callback', default='None')
