...
from mitsuba.core import Thread, Vector3f, Point3f
...
param_ref = (params['OBJMesh_7.vertex_positions']).torch()
param_ini = (params['OBJMesh_6.vertex_positions']).torch()
print(param_ref)
print(param_ini)

# Print the current value and keep a backup copy
params.keep(['OBJMesh_7.vertex_positions'])
...
params['OBJMesh_7.vertex_positions'] = param_ini
params.update()
...
for it in range(iterations):
    ...
    err_ref = objective(params_torch['OBJMesh_7.vertex_positions'], param_ref)
