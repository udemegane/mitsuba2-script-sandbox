...
bitmap_tmp = Bitmap('/home/udemegane/mitsuba2/docs/testscripts/01_render_scene/out.png', Bitmap.FileFormat.PNG).convert(Bitmap.PixelFormat.RGB, Struct.Type.Float32, srgb_gamma=False)
...
for it in range(iterations):
    ...
    write_bitmap('out_mycbox/out_%03i.png' % it, image, crop_size)
