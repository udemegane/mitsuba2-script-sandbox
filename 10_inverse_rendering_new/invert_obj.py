...
from mitsuba.core import xml, Thread, Transform4f, Bitmap, Float, Vector3f, UInt32, Struct
...
output_path = "output/invert_obj/"
if not os.path.isdir(output_path):
    os.makedirs(output_path)

# Load example scene
scene_folder = mitsuba_path + '/resources/data/docs/examples/invert_obj/'
...
#params_optim = { "translate" : translate_ref, }
...
img_ref_name = "output/invert_obj/out_ref.exr"
bitmap_tmp = Bitmap(img_ref_name, Bitmap.FileFormat.OpenEXR).convert(Bitmap.PixelFormat.RGB,
                                                                                Struct.Type.Float32,
                                                                                srgb_gamma=False)
import numpy as np
