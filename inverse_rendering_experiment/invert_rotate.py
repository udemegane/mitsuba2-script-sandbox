...
output_path = "output/invert_rotate/"
if not os.path.isdir(output_path):
    os.makedirs(output_path)

# Load example scene
scene_folder = mitsuba_path + '/resources/data/docs/examples/invert_rotate/'
...
iterations = 300
with open('/home/udemegane/mitsuba2/docs/examples/testprojects/data/csv/rotate_1axis.csv', 'w') as f:
    writer = csv.writer(f)
...
for it in range(iterations):
    ...
    with open('/home/udemegane/mitsuba2/docs/examples/testprojects/data/csv/rotate_1axis.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow([it, ob_val[0], params_optim["angle"]])
